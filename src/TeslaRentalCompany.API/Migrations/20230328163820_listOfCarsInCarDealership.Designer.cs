...
namespace TeslaRentalCompany.API.Migrations
{
    ...
    [Migration("20230328163820_listOfCarsInCarDealership")]
    partial class listOfCarsInCarDealership
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeslaRentalCompany.API.Entities.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeslaRentalCompany.API.Entities.CarDealership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeslaRentalCompany.API.Entities.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeslaRentalCompany.API.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeslaRentalCompany.API.Entities.Car", b =>
                {
                    b.HasOne("TeslaRentalCompany.API.Entities.CarDealership", "CarDealership")
                        .WithMany("ListOfCars")
            ...
            modelBuilder.Entity("TeslaRentalCompany.API.Entities.Reservation", b =>
                {
                    b.HasOne("TeslaRentalCompany.API.Entities.Car", "Car")
                        .WithMany("ListOfReservations")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TeslaRentalCompany.API.Entities.User", "User")
                        .WithMany("ListOfReservations")
